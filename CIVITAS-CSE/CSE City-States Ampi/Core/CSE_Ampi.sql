...
VALUES	('CSE_AMPI_SUZERAIN_GLASS_LUXURY_ATTACH',	'MODTYPE_CSE_ATTACH_PLAYERS',		'REQSET_CSE_PLAYER_IS_SUZERAIN'		),
		('CSE_AMPI_SUZERAIN_PLANTATION_PRODUCTION',	'MODTYPE_CSE_ATTACH_PLAYERS',		'REQSET_CSE_PLAYER_IS_SUZERAIN'		),
		('CSE_AMPI_GLASS_LUXURY',					'MODTYPE_CSE_RESOURCE_IMPORT',		NULL								),
		('CSE_AMPI_PLANTATION_PRODUCTION',			'MODTYPE_CSE_PLOT_YIELD_PLAYER',	'REQSET_CSE_PLOT_HAS_PLANTATION'	);
