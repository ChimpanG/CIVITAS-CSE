...
-----------------------------------------------
	...
	("en_US",	"LOC_CIVILIZATION_CSE_AMPI_NAME",			"Çatalhöyük"				),
	("en_US",	"LOC_CIVILIZATION_CSE_AMPI_ADJECTIVE",	"Çatalhöyük"				),
	("en_US",	"LOC_CIVILIZATION_CSE_AMPI_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_AMPI_NAME} city-state"		),
	("en_US",	"LOC_TRAIT_CSE_AMPI_NAME",				"{LOC_CIVILIZATION_CSE_AMPI_NAME} Suzerain Bonus"	),
	("en_US",	"LOC_TRAIT_CSE_AMPI_DESCRIPTION",		
	...
	("en_US",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_AMPI_CHAPTER_HISTORY_PARA_1",
