...
VALUES	('SCIENTIFIC',		'50,202,237,255',	'ICON_ENVOY_BONUS_SCIENCE',		'ICON_CITYSTATE_SCIENCE'		),
		('RELIGIOUS',		'255,246,235,255',	'ICON_ENVOY_BONUS_FAITH',		'ICON_CITYSTATE_FAITH'			),
		('TRADE',			'255,206,108,255',	'ICON_ENVOY_BONUS_GOLD',		'ICON_CITYSTATE_TRADE'			),
		('CULTURAL',		'214,102,255,255',	'ICON_ENVOY_BONUS_CULTURE',		'ICON_CITYSTATE_CULTURE'		),
		('MILITARISTIC',	'255,92,92,255',	'ICON_ENVOY_BONUS_MILITARY',	'ICON_CITYSTATE_MILITARISTIC'	),
		('INDUSTRIAL',		'255,149,77,255',	'ICON_ENVOY_BONUS_PRODUCTION',	'ICON_CITYSTATE_INDUSTRIAL'		);
