...
VALUES	('MODIFIER_CSE_CONSULAR_SEND_TRADE_BONUS',		'MODIFIER_PLAYER_CITIES_ADJUST_TRADE_ROUTE_YIELD_TO_OTHERS',	NULL							),
		...
		('MODIFIER_CSE_CONSULAR_GOVERNOR_LOYALTY_MOD',	'MODTYPE_CSE_CONSULAR_LOYALTY',									'REQSET_CSE_CITY_HAS_GOVERNOR'	),
...
VALUES	('MODIFIER_CSE_CONSULAR_SEND_TRADE_BONUS',		'YieldType',		'YIELD_GOLD'									),
		...
		('MODIFIER_CSE_CONSULAR_CAPITAL_PRESSURE_MOD',	'Amount',			1												),
		...
		('MODIFIER_CSE_CONSULAR_GOVERNOR_PRESSURE',		'ModifierId',		'MODIFIER_CSE_CONSULAR_GOVERNOR_LOYALTY_MOD'	),
