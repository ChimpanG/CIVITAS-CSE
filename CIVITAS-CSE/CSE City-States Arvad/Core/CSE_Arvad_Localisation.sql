...
-----------------------------------------------
	...
	("en_US",	"LOC_CIVILIZATION_CSE_ARVAD_NAME",			"Arvad"		),
	("en_US",	"LOC_CIVILIZATION_CSE_ARVAD_ADJECTIVE",		"Arvadite"	),
	("en_US",	"LOC_CIVILIZATION_CSE_ARVAD_DESCRIPTION",	"{LOC_CIVILIZATION_CSE_ARVAD_NAME} city-state"		),
	("en_US",	"LOC_TRAIT_CSE_ARVAD_NAME",					"{LOC_CIVILIZATION_CSE_ARVAD_NAME} Suzerain Bonus"	),
	("en_US",	"LOC_TRAIT_CSE_ARVAD_DESCRIPTION",		
	"Your City Centers gain +1 [ICON_FOOD] Food and +1 [ICON_PRODUCTION] Production for each adjacent Coast tile."	),

	("en_US",	"LOC_CITY_NAME_AMPI",						"{LOC_CIVILIZATION_CSE_ARVAD_NAME}"	),
	("en_US",	"LOC_CITY_NAME_KONYA",						"Konya"	),

	("en_US",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_ARVAD_CHAPTER_HISTORY_PARA_1",
	"Çatalhöyük was a large Neolithic and Chalcolithic proto-city settlement in southern Anatolia. It existed between 7500 BCE to 5700 BCE, flourishing circa 7000 BCE. The site overlooks the Konya Plain, southeast of ancient Iconium."	),
	("en_US",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_ARVAD_CHAPTER_HISTORY_PARA_2",
	...
	("en_US",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_ARVAD_CHAPTER_HISTORY_PARA_3",
