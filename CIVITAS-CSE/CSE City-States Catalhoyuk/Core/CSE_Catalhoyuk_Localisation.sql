...
-----------------------------------------------
	...
	("en_US",	"LOC_TRAIT_CSE_CATALHOYUK_NAME",				"{LOC_CIVILIZATION_CSE_CATALHOYUK_NAME} Suzerain Bonus"	),
	...
	("en_US",	"LOC_RESOURCE_CSE_LEATHER",						"Leather"	),
	("en_US",	"LOC_RESOURCE_CSE_WOOL",						"Wool"		);
